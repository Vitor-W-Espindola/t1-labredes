...
#define RTLP_OPERATION_CLIENT_LISTUSERS 0x7
#define RTLP_OPERATION_CLIENT_REQNICKNAME 0x8
#define RTLP_OPERATION_CLIENT_QUIT 0x9
...
#define RTLP_RESPONSE_NEW_NICKNAME 0x7
#define RTLP_RESPONSE_LISTUSERS 0x8
#define RTLP_RESPONSE_TRANSFERENABLED 0x9
#define RTLP_RESPONSE_TRANSFERDISABLED 0xA
